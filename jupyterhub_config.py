...
# c.JupyterHub.ip = 'jupyter.korpus.cz'
...
#
# Only override if configurable-http-proxy is not on your PATH, or if you need
# it to handle HTTP to HTTPS redirection
...
#
# Use with ssl_key
# c.JupyterHub.ssl_cert = '/etc/letsencrypt/live/jupyter.korpus.cz/cert.pem'

# Path to SSL key file for the public facing interface of the proxy
#
# Use with ssl_cert
# c.JupyterHub.ssl_key = '/etc/letsencrypt/live/jupyter.korpus.cz/privkey.pem'
...
c.Authenticator.admin_users = set(["lukes"])
